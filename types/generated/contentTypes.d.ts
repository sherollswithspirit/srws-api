...
export interface ApiAbilityAbility extends Struct.SingleTypeSchema {
  collectionName: 'abilities';
  info: {
    displayName: 'My Abilities';
...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Quote: Schema.Attribute.Component<'quote.quotes', true>;
...
export interface ApiBookingBooking extends Struct.SingleTypeSchema {
...
export interface ApiClairClair extends Struct.CollectionTypeSchema {
  collectionName: 'clairs';
  info: {
    displayName: 'Psychic Clairs';
    pluralName: 'clairs';
    singularName: 'clair';
  };
  options: {
...
export interface ApiEnergyAndFrequencyEnergyAndFrequency
  ...
  info: {
    ...
    pluralName: 'energy-and-frequencies';
    singularName: 'energy-and-frequency';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::energy-and-frequency.energy-and-frequency'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Subtitle: Schema.Attribute.String;
...
export interface ApiToolTool extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Tools and Practices';
    pluralName: 'tools';
    singularName: 'tool';
  };
  options: {
